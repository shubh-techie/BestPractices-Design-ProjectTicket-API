...
{
    public class GoTicketDbContext : DbContext
    {
        public GoTicketDbContext(DbContextOptions<GoTicketDbContext> options)
          : base(options)
        {
        }
        ...
        {
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(GoTicketDbContext).Assembly);
